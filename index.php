	...
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide p1">
				...
				<img class="e-8 ani" src="images/p1/8.png" alt="" swiper-animate-effect="flash" swiper-animate-delay="0.6s">															
			</div>
			...
			<div class="swiper-slide p5">
				...
				<div  class="e-2">
					<input id="name" type="text" class="in-1" placeholder="姓名">						
				</div>	
				<div  class="e-3">
					<input id="phone" type="text" class="in-1" placeholder="电话">						
				</div>			
